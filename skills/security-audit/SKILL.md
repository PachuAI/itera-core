---
name: security-audit
description: 'Auditoría de seguridad de un repo ITERA multi-tenant — lo que /check no ve: ownership/IDOR, auth guards en API routes, tablas JOIN, FK de entrada, campos de control, sesión vs DB, uploads, autorización IA. Correr tras tocar API routes, services con writes, modelos nuevos o endpoints públicos. /security-audit en Claude, $security-audit en Codex.'
model: sonnet
---
